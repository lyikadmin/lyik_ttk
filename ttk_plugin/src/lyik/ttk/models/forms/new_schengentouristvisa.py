...
#   filename:  <stdin>
#   timestamp: 2025-07-02T06:13:50+00:00
...
class RootConsultantInfoAppointments(BaseModel):
    ...
    appointment_document: Optional[Union[str, Dict[str, Any]]] = Field(
...
class RootConsultantInfoConfirmedAccommodation(BaseModel):
    ...
    confirmed_accommodation: Optional[Union[str, Dict[str, Any]]] = Field(
...
class RootConsultantInfoConfirmedFlightTicket(BaseModel):
    ...
    confirmed_flight_ticket: Optional[Union[str, Dict[str, Any]]] = Field(
        None, description="Upload an image/file", title="Confirmed Flight Ticket"
    )
...
class RootConsultantInfoDummyAccommodation(BaseModel):
    ...
    dummy_accommodation: Optional[Union[str, Dict[str, Any]]] = Field(
...
class RootConsultantInfoDummyFlightTicket(BaseModel):
    ...
    dummy_flight_ticket: Optional[Union[str, Dict[str, Any]]] = Field(
        None, description="Upload an image/file", title="Dummy Flight Ticket"
    )
...
class RootConsultantInfoItineraryAddon(BaseModel):
    ...
    itinerary: Optional[Union[str, Dict[str, Any]]] = Field(
...
class RootConsultantInfoTravelInsurances(BaseModel):
    ...
    travel_insurance_file: Optional[Union[str, Dict[str, Any]]] = Field(
        None, description="Upload an image/file", title="Travel Insurance"
    )
