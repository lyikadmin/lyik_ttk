...
#   filename:  <stdin>
#   timestamp: 2025-06-27T07:13:03+00:00
...
class RootAccomodationBookedAppointment(BaseModel):
    ...
    booking_upload: Optional[Union[str, Dict[str, Any]]] = Field(
        None,
        description="Upload an image/file of the accommodation booking document.",
...
class RootItineraryAccomodationAddOnServiceItinerary(BaseModel):
    ...
    display_add_on_service_itinerary: Optional[str] = Field(
        None,
        description='<!-- <div style="\n  display: flex;\n  align-items: left;\n  justify-content: left;\n  text-align: left;\n  margin-left: 15px;\n">\n  To know the cost, please refer the <strong>&nbsp;Add-On Cart Section</strong>.\n</div> -->\n<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Centered Paragraph</title>\n  <style>\n    .message-box {\n      font-family: \'Inter\', sans-serif;\n      font-weight: 500;\n      font-size: 20px;\n      text-align: left;\n      \n    }\n  </style>\n</head>\n<body>\n    <div class="message-box">\n        <div style="font-weight: 600;">Need assistance with creating your itinerary?</div> <br>\n        Visit the Add-On Cart to avail this service for a small fee.\n    </div>\n</body>\n</html>',
        title="Display Field",
    )
...
class RootItrAcknowledgementUpload(BaseModel):
    ...
    display_itr_acknowledgement_instructions: Optional[str] = Field(
        None,
        description='<div style="\ndisplay: flex;\njustify-content: center;\nalign-items: center;">\n\n<div style="\n  text-align: center;\n  width: 1060px;\n  font-family: \'Inter\', sans-serif;\n  font-weight: 500;\n  font-size: 20px;\n  line-height: 32px;\n  color: #000000;\n  text-align: center;\n">\nIf you’d like us to review your ITR Acknowledgement Document to make sure it meets the guidelines, please upload it here.\n</div>\n</div>',
        title="Display Field",
    )
...
class RootTicketingAddOnService(BaseModel):
    ...
    display_add_on: Optional[str] = Field(
        None,
        description='<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Centered Paragraph</title>\n  <style>\n    .message-box {\n      font-family: \'Inter\', sans-serif;\n      font-weight: 500;\n      font-size: 20px;\n      text-align: left;\n      \n    }\n  </style>\n</head>\n<body>\n    <div class="message-box">\n        <div style="font-weight: 600;">Need assistance with booking your Flight Tickets?</div> <br>\n        Visit the Add-On Cart to avail this service for a small fee.\n    </div>\n</body>\n</html>',
        title="Display Field",
    )
...
class RootTravelInsuranceAddOnService(BaseModel):
    ...
    display_add_on: Optional[str] = Field(
        None,
        description='<!-- <div style="\n  display: flex;\n  align-items: left;\n  justify-content: left;\n  text-align: left;\n  margin-left: 15px;\n">\nTo know the cost, please refer to the <strong>&nbsp;Add-On Cart Section</strong>.\n</div> -->\n<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Centered Paragraph</title>\n  <style>\n    .message-box {\n      font-family: \'Inter\', sans-serif;\n      font-weight: 500;\n      font-size: 20px;\n      text-align: left;\n      \n    }\n  </style>\n</head>\n<body>\n    <div class="message-box">\n        <div style="font-weight: 600;">Need assistance with buying Travel Insurance?</div> <br>\n        Visit the Add-On Cart to avail this service for a small fee.\n    </div>\n</body>\n</html>',
        title="Display Field",
    )
...
class RootDocketInfo(BaseModel):
    ...
    display_bottom_text: Optional[str] = Field(
        None,
        description='<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Center Content</title>\n  <style>\n    .center-wrapper {\n      display: flex;\n      justify-content: center;\n      align-items: center;\n    }\n\n    .message-box {\n      width: 1060px;\n      font-family: \'Inter\', sans-serif;\n      font-weight: 500;\n      font-size: 20px;\n      line-height: 32px;\n      color: #000000;\n      text-align: center;\n    }\n  </style>\n</head>\n<body>\n  <div class="center-wrapper">\n    <div class="message-box">\n      <h1 style="font-weight: 700; margin-bottom: 16px;">\n        Your application is now ready to be submitted at your Visa Appointment!\n      </h1>\n      <ul style="list-style: none; margin: 0; padding: 0;">\n        <li style="margin-bottom: 8px;">\n          Download your Docket (Ajay_Docket.zip).\n        </li>\n        <li style="margin-bottom: 8px;">\n          This ZIP file contains all necessary documents (excluding the originals you need to carry) along with an \'<strong>Instruction Sheet</strong>\'.\n        </li>\n        <li>\n          Kindly print the documents, arrange them in the order specified in the <strong>Instruction Sheet</strong>, and bring them to your Visa Appointment.\n        </li>\n      </ul>\n    </div>\n  </div>\n</body>\n</html>\n',
        title="Display Field",
    )
...
class Schengentouristvisa(BaseModel):
    ...
    docket_info: Optional[RootDocketInfo] = Field(None, title="Docket")
