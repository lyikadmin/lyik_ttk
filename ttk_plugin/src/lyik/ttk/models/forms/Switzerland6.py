...
class Switzerland6(BaseModel):
    visa_surname_family_name: str = ""  # PDF field: visa_surname_family_name
    visa_surname_at_birth: str = ""  # PDF field: visa_surname_at_birth
    visa_first_name: str = ""  # PDF field: visa_first_name
    visa_dob: str = ""  # PDF field: visa_dob
    visa_cob: str = ""  # PDF field: visa_cob
    visa_sex_male: bool = False  # PDF field: visa_sex_male
    ...
    visa_pob: str = ""  # PDF field: visa_pob
    visa_curr_natl: str = ""  # PDF field: visa_curr_natl
    visa_oth_natl: str = ""  # PDF field: visa_oth_natl
    visa_civil_sts_oth_txt: str = ""  # PDF field: visa_civil_sts_oth_txt
    visa_natl_at_birth: str = ""  # PDF field: visa_natl_at_birth
    visa_parental_auth: str = ""  # PDF field: visa_parental_auth
    visa_nat_id_num: str = ""  # PDF field: visa_nat_id_num
    ...
    visa_num_trav_doc: str = ""  # PDF field: visa_num_trav_doc
    visa_fam_mem_eu_surname: str = ""  # PDF field: visa_fam_mem_eu_surname
    visa_fam_mem_eu_dob: str = ""  # PDF field: visa_fam_mem_eu_dob
    visa_doi: str = ""  # PDF field: visa_doi
    visa_val_til: str = ""  # PDF field: visa_val_til
    visa_issued_by_ctry: str = ""  # PDF field: visa_issued_by_ctry
    visa_fam_mem_eu_1st_nm: str = ""  # PDF field: visa_fam_mem_eu_1st_nm
    visa_fam_mem_eu_natl: str = ""  # PDF field: visa_fam_mem_eu_natl
    visa_fam_mem_eu_num_trav_doc: str = ""  # PDF field: visa_fam_mem_eu_num_trav_doc
    ...
    visa_typ_trav_doc_diplomatic: bool = False  # PDF field: visa_typ_trav_doc_diplomatic
    ...
    visa_app_addr: str = ""  # PDF field: visa_app_addr
    visa_app_tel_num: str = ""  # PDF field: visa_app_tel_num
    visa_oth_natl_no: bool = False  # PDF field: visa_oth_natl_no
    visa_oth_natl_yes: bool = False  # PDF field: visa_oth_natl_yes
    visa_curr_occ: str = ""  # PDF field: visa_curr_occ
    ...
    visa_jrn_purpose_study: bool = False  # PDF field: visa_jrn_purpose_study
    ...
    visa_addl_stay_info: str = ""  # PDF field: visa_addl_stay_info
    visa_mem_main_dst: str = ""  # PDF field: visa_mem_main_dst
    visa_mem_1st_entry: str = ""  # PDF field: visa_mem_1st_entry
    ...
    visa_oth_natl_yes_res_num: str = ""  # PDF field: visa_oth_natl_yes_res_num
    visa_oth_natl_yes_val_til: str = ""  # PDF field: visa_oth_natl_yes_val_til
    visa_jrn_purpose_oth_txt: str = ""  # PDF field: visa_jrn_purpose_oth_txt
    visa_invite_temp_accom: str = ""  # PDF field: visa_invite_temp_accom
    visa_invite_temp_accom_comm_details: str = ""  # PDF field: visa_invite_temp_accom_comm_details
    visa_invite_org: str = ""  # PDF field: visa_invite_org
    visa_invite_org_comm_details: str = ""  # PDF field: visa_invite_org_comm_details
    ...
    visa_invite_temp_accom_tel_num: str = ""  # PDF field: visa_invite_temp_accom_tel_num
    visa_invite_temp_accom_tel_mun: str = ""  # PDF field: visa_invite_temp_accom_tel_mun
    visa_1st_arrival_date: str = ""  # PDF field: visa_1st_arrival_date
    visa_dptr_date: str = ""  # PDF field: visa_dptr_date
    visa_fingerprint_yes_date: str = ""  # PDF field: visa_fingerprint_yes_date
    visa_fingerprint_yes_sticker_num: str = ""  # PDF field: visa_fingerprint_yes_sticker_num
    visa_permit_final_ctry_dest_issued_by: str = ""  # PDF field: visa_permit_final_ctry_dest_issued_by
    visa_permit_final_ctry_dest_valid_from: str = ""  # PDF field: visa_permit_final_ctry_dest_valid_from
    visa_permit_final_ctry_dest_til: str = ""  # PDF field: visa_permit_final_ctry_dest_til
    ...
    visa_fingerprint_yes: bool = False  # PDF field: visa_fingerprint_yes
    ...
    visa_means_support_oth_expn_covered: bool = False  # PDF field: visa_means_support_oth_expn_covered
    ...
    visa_applicant_diff_surnm_nm: str = ""  # PDF field: visa_applicant_diff_surnm_nm
    visa_applicant_diff_addr: str = ""  # PDF field: visa_applicant_diff_addr
    visa_applicant_diff_tel_num: str = ""  # PDF field: visa_applicant_diff_tel_num
