...
#   filename:  <stdin>
#   timestamp: 2025-05-12T10:58:42+00:00
...
class RootAdditionalDetails(BaseModel):
    ...
    personal_details_option: Optional[RootAdditionalDetailsPersonalDetailsOption] = (
...
class RootResidentialAddress(BaseModel):
    ...
    residential_address_card: Optional[RootResidentialAddressResidentialAddressCard] = (
...
class FieldGrpRootAttachmentsInfopaneAttachDocuments(BaseModel):
    ...
    attachmentgroup: Optional[RootAttachmentsInfopaneAttachDocumentsAttachmentgroup] = (
...
class RootAttachmentsInfopane(BaseModel):
    ...
    attach_documents: Optional[List[FieldGrpRootAttachmentsInfopaneAttachDocuments]] = (
...
class Org26843479Frm5809021Model(BaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
