...
class RootTravelTravelDetails(BaseModel):
    ...
    visa_processing_type: Optional[VISAPROCESSINGTYPE] = Field(
        'Normal', description='Enter Visa Processing Type', title='Visa Processing Type'
    )
    earliest_appointment_availability: Optional[date] = Field(
        None,
        description='Enter Earliest Appointment Availability',
        title='Earliest Appointment Availability',
    )
    ...
    visa_cost: Optional[str] = Field(
        None,
        description='Enter Visa Payment Difference',
        title='Visa Payment Difference',
    )
...
class RootTravel(BaseModel):
    ...
    visa_cost_consent: Optional[CONSENTVISAFEE] = Field(None, title='')
