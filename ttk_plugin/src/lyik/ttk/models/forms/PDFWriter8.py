...
if __name__ == "__main__":
    ...
    try_map("visa_civil_widow", lambda: schengen_model.passport.other_details.civil_status == CIVILMARITALSTATUS.WIDOW)
    ...
    #         continue
    #     if schengen_key not in schengen_flat:
    #         print(f"{schengen_key} ❌ not in Schengen model")
    #         continue
    #     print(f"{swiss_key}  <=OOOOO=>  {schengen_key}")
    #     # sample_data[swiss_key] = schengen_key
