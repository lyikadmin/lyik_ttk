    ...
    try:
        ...
        if visa_info and visa_info.visa_request:
            ...
            if visa_info.visa_request.arrival_date:
                pdf_model.visa_dptr_date = visa_info.visa_request.arrival_date.strftime(
                    "%d-%m-%Y"
                )  #

            pdf_model.visa_addl_stay_info = visa_info.visa_request.purpose_of_stay  #
        ...
        if passport and passport.passport_details:
            ...
            pdf_model.visa_typ_trav_doc_service = (
                passport.passport_details.type_of_passport == PASSPORTTYPE.SERVICE  #
            )
            ...
            pdf_model.visa_typ_trav_doc_diplomatic = (
                passport.passport_details.type_of_passport == PASSPORTTYPE.DIPLOMATIC  #
            )
        ...
        if additional_details:
            ...
            if pdf_model.visa_trav_cost_oth:
                pdf_model.visa_trav_cost_oth_txt = additional_details.others_specify  #
            if (
                pdf_model.visa_trav_cost_spons
                | pdf_model.visa_trav_cost_31_32
                | pdf_model.visa_trav_cost_oth
        ...
        if additional_details and additional_details.national_id:
            pdf_model.visa_nat_id_num = additional_details.national_id.aadhaar_number  #
        ...
        if additional_details and additional_details.family_eu:
            ...
            pdf_model.visa_fam_mem_eu_natl = additional_details.family_eu.nationality  #
            ...
            pdf_model.visa_fam_rs_eu_child = (
                additional_details.family_eu.relationship == RELATIONSHIPWITHEU.CHILD  #
            )
            ...
            pdf_model.visa_fam_rs_eu_oth = (
                additional_details.family_eu.relationship == RELATIONSHIPWITHEU.OTHER  #
            )
        ...
        if additional_details and additional_details.travel_other == OPTION.YES:
            ...
            pdf_model.visa_mem_main_dst = visa_info.visa_request.to_country_full_name  #
        ...
        if resi_address:
            ...
            pdf_model.visa_oth_natl_no = resi_address.other_nationality == OPTION.NO  #
        ...
        if (
            ...
            if booked:
                ...
                pdf_model.visa_invite_temp_accom_tel_num = booked.accommodation_phone
        ...
        raise PluginException(
            message=get_error_message(error_message_code="LYIK_ERR_UNEXPECTED_ERROR"),
