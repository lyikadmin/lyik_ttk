...
class CopyPassportAddress(PreActionProcessorSpec):
    ...
    async def pre_action_processor(
        ...
        from the passport address into the residential‐address card.
        """
        ...
        new_card = RootResidentialAddressResidentialAddressCard(
        ...
        data.setdefault("residential_address", {})["residential_address_card"] = new_card.model_dump()
